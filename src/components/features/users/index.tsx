...
import { createUser, deleteUser, getAllUsers, signIn, updateUser, type Candidate } from "../../../services/supebase";
          ...
          <Dialog open={isEditing} onOpenChange={setIsEditing}>
            ...
            <DialogContent>
              ...
              <div className="grid gap-4">
                <div>
                  <Label>Name</Label>
                  <Input name="name" value={formData && formData?.name !== null ? formData.name : ''} onChange={handleChange} />
                </div>
                <div>
                  <Label>Email</Label>
                  <Input name="email" value={formData && formData?.email !== null ? formData.email : ''} onChange={handleChange} />
                </div>
                <div>
                  <Label>Phone</Label>
                  <Input name="phone" value={formData && formData?.phone !== null ? formData.phone : ''} onChange={handleChange} />
                </div>
                <div>
                  <Label>Role</Label>
                  <Select value={formData && formData?.role !== null ? formData.role[0] : ''} onValueChange={handleRoleChange}>
                    <SelectTrigger>
